# This is the R replication code for "Networks of Evidence Use in the Context of Federal Childhood Obesity Policymaking" by Brandon Kramer, Matthew Weber, and Itzhak Yanovitsky. 
...
# In this paper, we examined how policymakers share evidence in the context of developing childhood obesity legislation using exponential random graph models (ERGMs). We mainly intended to test three core theories drawn from past literature in the area. First, we tested whether homophily (i.e. shared attributes like political party membership) impacts the likelihood of policymakers to share evidence. Second, we tested whether strucutural features of the policymaking network, such as individuals' degree of connectivity, impacted tie formation. Lastly, we analysed whether knowledge brokering had any influence on ties forming between policymakers. In our final four models included in manuscript, we show that a range of structural connectivity, which we refer to as "structural sweet spots", as well as various forms of homophily, like political party, political branch and committee membership, provide the best fitting model to capture how policymakers share evidence in this context. 

# Below, we have outlined some of the logic by which we tested these theories through the use of ERGMs in ___ parts. First, we load our packages and construct the network. In the second section, we provide an outline of the four final models discussed in our manuscript, including the goodness of fit (GOF) parameters for these models. Third, 
...
ev.4_11d <- ergm(EVNETN~edges + degree(4:11), control=control.ergm(parallel=16, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.4_11d)

# Final model 2: Looks at best fitting model of nodal attributes 

ev.polfac.branchfac.core5 <- ergm(EVNETN~edges + nodefactor("political") + nodefactor("branch") + nodematch("appropriations") + nodematch("help") + nodematch("agriculture") + nodematch("energycomm") + nodematch("educ_wf"), control=control.ergm(parallel=16, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.4_11d.polfac.branchfac <- ergm(EVNETN~edges + degree(4:11) + nodefactor("political") + nodefactor("branch"), control=control.ergm(parallel=16, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.4_11d.polfac.branchfac.core5 <- ergm(EVNETN~edges + degree(4:11) + nodefactor("political") + nodefactor("branch") + nodematch("appropriations") + nodematch("help") + nodematch("agriculture") + nodematch("energycomm") + nodematch("educ_wf"), control=control.ergm(parallel=16, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.2deg <- ergm(EVNETN~edges + degree(2), control=control.ergm(parallel=32, parallel.type="PSOCK"))
summary(ev.2deg)

ev.3deg <- ergm(EVNETN~edges + degree(3), control=control.ergm(parallel=32, parallel.type="PSOCK"))
summary(ev.3deg)

ev.4deg <- ergm(EVNETN~edges + degree(4), control=control.ergm(parallel=32, parallel.type="PSOCK"))
summary(ev.4deg)

ev.2_4deg <- ergm(EVNETN~edges + degree(2:4), control=control.ergm(parallel=32, parallel.type="PSOCK"))
summary(ev.2_4deg)

# Testing weighted degree ranges
ev.2gwdeg <- ergm(EVNETN~edges + gwdegree(2), control=control.ergm(parallel=32, parallel.type="PSOCK"))
summary(ev.2gwdeg)

ev.3gwdeg <- ergm(EVNETN~edges + gwdegree(3), control=control.ergm(parallel=32, parallel.type="PSOCK"))
summary(ev.3gwdeg)

ev.4gwdeg <- ergm(EVNETN~edges + gwdegree(4), control=control.ergm(parallel=32, parallel.type="PSOCK"))
summary(ev.4gwdeg)

ev.2_4gwdeg <- ergm(EVNETN~edges + gwdegree(2:4), control=control.ergm(parallel=32, parallel.type="PSOCK"))
summary(ev.2_4gwdeg)

# Testing kstar parameters 

ev.k2 <- ergm(EVNETN~edges + kstar(2), control=control.ergm(parallel=32, parallel.type="PSOCK"))
summary(ev.k2)

ev.k3 <- ergm(EVNETN~edges + kstar(3), control=control.ergm(parallel=32, parallel.type="PSOCK"))
summary(ev.k3)

ev.k4 <- ergm(EVNETN~edges + kstar(4), control=control.ergm(parallel=32, parallel.type="PSOCK"))
summary(ev.k4)

ev.k2_4 <- ergm(EVNETN~edges + kstar(2:4), control=control.ergm(parallel=32, parallel.type="PSOCK"))
summary(ev.k4)

# Testing Altkstar

ev.altk2 <- ergm(EVNETN~edges + altkstar(2), control=control.ergm(parallel=32, parallel.type="PSOCK"))
summary(ev.k2_4)

ev.altk3 <- ergm(EVNETN~edges + altkstar(3), control=control.ergm(parallel=32, parallel.type="PSOCK"))
summary(ev.altk3)

ev.altk4 <- ergm(EVNETN~edges + altkstar(4), control=control.ergm(parallel=32, parallel.type="PSOCK"))
summary(ev.altk4)

ev.altk2_4 <- ergm(EVNETN~edges + altkstar(2:4), control=control.ergm(parallel=32, parallel.type="PSOCK"))
summary(ev.altk2_4)
...
ev.d4.bal.affil <- ergm(EVNETN~edges + degree(2) + balance + nodematch("affil"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.d4.bal.affil)
mcmc.diagnostics(ev.d4.bal.affil)
evgof.1.d4.bal.affil<-gof(ev.d4.bal.affil)
plot(evgof.1.d4.bal.affil)

ev.d4.affil <- ergm(EVNETN~edges + degree(4) + nodematch("affil"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.d4.affil)
mcmc.diagnostics(ev.d4.affil)
evgof.1.d4.affil<-gof(ev.d4.affil)
plot(evgof.1.d4.affil)

ev.k4.affil <- ergm(EVNETN~edges + kstar(4) + nodematch("affil"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.k4.affil)
...
ev.d4.gend <- ergm(EVNETN~edges + degree(4) + nodematch("gender"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.d4.gend)
mcmc.diagnostics(ev.d4.gend)
evgof.1.d4.gend<-gof(ev.d4.gend)
plot(evgof.1.d4.gend)

ev.k4.gend <- ergm(EVNETN~edges + kstar(4) + nodematch("gender"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.k4.gend)
mcmc.diagnostics(ev.k4.gend)
evgof.1.k4.gend<-gof(ev.k4.gend)
plot(evgof.1.k4.gend)

ev.iso.gen <- ergm(EVNETN~edges + isolates + nodematch("gender"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.iso.gen)
...
ev.d4.tenure <- ergm(EVNETN~edges + degree(4) + nodematch("tenure"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.d4.tenure)
mcmc.diagnostics(ev.d4.tenure)
evgof.1.d4.tenure<-gof(ev.d4.tenure)
plot(evgof.1.d4.tenure)

ev.k4.tenure <- ergm(EVNETN~edges + kstar(4) + nodematch("tenure"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.pnp <- ergm(EVNETN~edges + nodematch("polnotpol"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.pnp)
mcmc.diagnostics(ev.pnp)
evgof.1.pnp<-gof(ev.pnp)
plot(evgof.1.pnp)

ev.d4.pnp <- ergm(EVNETN~edges + degree(4) + nodematch("polnotpol"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.d4.pnp)
mcmc.diagnostics(ev.d4.pnp)
evgof.1.d4.pnp<-gof(ev.d4.pnp)
plot(evgof.1.d4.pnp)

ev.k4.pnp <- ergm(EVNETN~edges + kstar(4) + nodematch("polnotpol"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.k4.pnp)
mcmc.diagnostics(ev.k4.pnp)
evgof.1.k4.pnp<-gof(ev.k4.pnp)
plot(evgof.1.k4.pnp)

ev.k4.iso.pnp <- ergm(EVNETN~edges + kstar(4) + isolates + nodematch("polnotpol"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.k4.iso.pnp)
mcmc.diagnostics(ev.k4.iso.pnp)
evgof.1.k4.iso.pnp<-gof(ev.k4.iso.pnp)
plot(evgof.1.k4.iso.pnp)

ev.d4.k4.pnp <- ergm(EVNETN~edges + degree(4) + kstar(4) + nodematch("polnotpol"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.d4.affil.gend <- ergm(EVNETN~edges + degree(4) + nodematch("affil") + nodematch("gender"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.d4.affil.pol <- ergm(EVNETN~edges + degree(4) + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.d4.affil.pol)
mcmc.diagnostics(ev.d4.affil.pol)
evgof.1.d4.affil.pol<-gof(ev.d4.affil.pol)
plot(evgof.1.d4.affil.pol)

ev.d4.affil.gend.pol <- ergm(EVNETN~edges + degree(4) + nodematch("affil") + nodematch("gender") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.d4.affil.gend.ten <- ergm(EVNETN~edges + degree(4) + nodematch("affil") + nodematch("gender") + nodematch("tenure"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.d4.affil.gend.pol.ten <- ergm(EVNETN~edges + degree(4) + nodematch("affil") + nodematch("gender") + nodematch("political") + nodematch("tenure"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.d4.covten <- ergm(EVNETN~edges + degree(4) + nodecov("tenure"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.d4.covten)
mcmc.diagnostics(ev.d4.covten)
evgof.1.d4.covten<-gof(ev.d4.covten)
plot(evgof.1.d4.covten)

ev.k4.covten <- ergm(EVNETN~edges + kstar(4) + nodecov("tenure"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.k4.covten)
mcmc.diagnostics(ev.k4.covten)
evgof.1.k4.covten<-gof(ev.k4.covten)
plot(evgof.1.k4.covten)

ev.d4.k4.covten <- ergm(EVNETN~edges + degree(4) + kstar(4) + nodecov("tenure"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.d4.k4.covten)
mcmc.diagnostics(ev.d4.k4.covten)
evgof.1.d4.k4.covten<-gof(ev.d4.k4.covten)
plot(evgof.1.d4.k4.covten)

ev.4d.covten.pnp <- ergm(EVNETN~edges + degree(4) + nodecov("tenure") + nodematch("polnotpol"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.4d.md.covten.pnp <- ergm(EVNETN~edges + degree(4) + meandeg + nodecov("tenure") + nodematch("polnotpol"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.3_6d.20d.covten.aff.pol.gend <- ergm(EVNETN~edges + degree(3:6) + degree(20) + nodecov("tenure")  + nodematch("affil") + nodematch("political") + nodematch("gender"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.3_6d.8_12d.20d.covten.aff.pol.gend <- ergm(EVNETN~edges + degree(3:6) + degree(8:12) + degree(20) + nodecov("tenure")  + nodematch("affil") + nodematch("political") + nodematch("gender"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.4_6d.8_12d.20d.covten.aff.pol.gend <- ergm(EVNETN~edges + degree(4:6) + degree(8:12) + degree(20) + nodecov("tenure")  + nodematch("affil") + nodematch("political") + nodematch("gender"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.4_6d.8_12d.20d.covten.aff.pol.gend)
...
ev.5_6d.8_12d.20d.covten.aff.pol.gend <- ergm(EVNETN~edges + degree(5:6) + degree(8:12) + degree(20) + nodecov("tenure")  + nodematch("affil") + nodematch("political") + nodematch("gender"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.4_6d.8_11d.20d.covten.aff.pol.gend <- ergm(EVNETN~edges + degree(4:6) + degree(8:11) + degree(20) + nodecov("tenure")  + nodematch("affil") + nodematch("political") + nodematch("gender"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.3_4d.6d.8_9d.11d.20d.covten.aff.pol.gend <- ergm(EVNETN~edges + degree(3:4) + degree(6) + degree(8:9) + degree(11) + degree(20) + nodecov("tenure")  + nodematch("affil") + nodematch("political") + nodematch("gender"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.3_20d.covten.aff <- ergm(EVNETN~edges + degree(3:20) + nodecov("tenure")  + nodematch("affil"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.3_12d.covten.aff <- ergm(EVNETN~edges + degree(3:12) + nodecov("tenure")  + nodematch("affil"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.3_12d.covten.aff.pol <- ergm(EVNETN~edges + degree(3:12) + nodecov("tenure")  + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.3_11d.covten.aff.pol <- ergm(EVNETN~edges + degree(3:11) + nodecov("tenure")  + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.3_11d.covten.aff <- ergm(EVNETN~edges + degree(3:11) + nodecov("tenure")  + nodematch("affil"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.3_11d.nf_aff.ncov_ten.pol <- ergm(EVNETN~edges + degree(3:11) + nodefactor("affil") + nodecov("tenure") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.3_11d.aff.ncov_ten.nf_pol <- ergm(EVNETN~edges + degree(3:11) + nodematch("affil") + nodecov("tenure") + nodefactor("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.3_11d.nf_aff.ncov_ten.nf_pol <- ergm(EVNETN~edges + degree(3:11) + nodefactor("affil") + nodecov("tenure") + nodefactor("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.3_11d.nm_affil.pol.nc_ten <- ergm(EVNETN~edges + degree(3:11) + nodemix("affil", base = 0) + nodematch("political") + nodecov("tenure"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.3_11d.nm_pol.affil.nc_ten <- ergm(EVNETN~edges + degree(3:11) + nodemix("political", base = 0) + nodematch("affil") + nodecov("tenure"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.3_11d.nm_pol.nm_affil.nc_ten <- ergm(EVNETN~edges + degree(3:11) + nodemix("affil", base = 0) + nodemix("political", base=0) + nodecov("tenure"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.3_11d.ad_affil.pol.nc_ten <- ergm(EVNETN~edges + degree(3:11) + absdiff("affil") + nodematch("political") + nodecov("tenure"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.3_11d.ad_pol.affil.nc_ten <- ergm(EVNETN~edges + degree(3:11) + absdiff("political") + nodematch("affil") + nodecov("tenure"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.3_11d.ad_pol.ad_affil.nc_ten <- ergm(EVNETN~edges + degree(3:11) + absdiff("political") + absdiff("affil") + nodecov("tenure"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.gwesp25.ten.aff.pol <- ergm(EVNETN~edges + gwesp(0.25,fixed=T) + nodecov("tenure")  + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.g50.3_11d.covten.aff.pol <- ergm(EVNETN~edges + gwesp(0.50,fixed=T) + degree(3:11) + nodecov("tenure")  + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.g75.3_11d.covten.aff.pol <- ergm(EVNETN~edges + gwesp(0.75,fixed=T) + degree(3:11) + nodecov("tenure")  + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.esp10.ten.aff.pol <- ergm(EVNETN~edges + esp(0.10) + nodecov("tenure")  + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.esp25.ten.aff.pol <- ergm(EVNETN~edges + esp(0.25) + nodecov("tenure")  + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.esp75.3_11d.ten.aff.pol <- ergm(EVNETN~edges + esp(0.75) + degree(3:11) + nodecov("tenure")  + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.esp25.gwdsp25.nc_ten.aff.pol <- ergm(EVNETN~edges + esp(0.25) + gwdsp(0.25, fixed = FALSE) + nodecov("tenure")  + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.gwdsp25.gwesp25.nc_ten.aff.pol <- ergm(EVNETN~edges + gwdsp(0.25, fixed = FALSE) + gwesp(0.25, fixed = FALSE) + nodecov("tenure")  + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.gwdsp25.3_11d.nc_ten.aff.pol <- ergm(EVNETN~edges + gwdsp(0.25, fixed = FALSE) + degree(3:11) + nodecov("tenure")  + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.esp25.covten.aff.pol <- ergm(EVNETN~edges + esp(0.25) + nodecov("tenure")  + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.gwesp50.3_11d.covten.aff.pol <- ergm(EVNETN~edges + gwesp(0.50) + degree(3:11) + nodecov("tenure")  + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.esp25.dsp3 <- ergm(EVNETN~edges + esp(0.25) + dsp(3), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.esp25.dsp10 <- ergm(EVNETN~edges + esp(0.25) + dsp(10), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.8_11d.covten.aff.pol <- ergm(EVNETN~edges + degree(8:11) + nodecov("tenure") + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.6_11d.covten.aff.pol <- ergm(EVNETN~edges + degree(6:11) + nodecov("tenure") + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.4_11d.covten.aff.pol <- ergm(EVNETN~edges + degree(4:11) + nodecov("tenure") + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.4_11d.esp10.covten.aff.pol <- ergm(EVNETN~edges + degree(4:11) + esp(10) + nodecov("tenure") + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.4_1120d.esp7_1320.covten.aff.pol <- ergm(EVNETN~edges + degree(4:11) + degree(20) + esp(7:13) + esp(19) + nodecov("tenure") + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.4_1120d.esp3_1320.nsp1_2.aff.pol <- ergm(EVNETN~edges + degree(4:11) + degree(20) + esp(3:13) + esp(19) + nsp(1:2) + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.4_1120d.esp5_1320.nsp1_2.dsp1_2.aff.pol <- ergm(EVNETN~edges + degree(4:11) + degree(20) + esp(5:13) + esp(19) + nsp(1:2) + dsp(1:2) + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.14_111420d.esp5_1320.nsp1_2.dsp1_2 <- ergm(EVNETN~edges + degree(1) + degree(4:11) + degree(14) + degree(20) + esp(5:13) + esp(19) + nsp(1:2) + dsp(1:2), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.4_1120d.esp3_1320.nsp1_2.dsp1_2.aff.pol <- ergm(EVNETN~edges + degree(4:11) + degree(20) + esp(3:13) + esp(19) + nsp(1:2) + dsp(1:2) + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.4_11d.nsp1_2.dsp1_2.aff.pol <- ergm(EVNETN~edges + degree(4:11) + nsp(1:2) + dsp(1:2) + nodematch("affil") + nodematch("political"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.4_1120d.esp5_1320.nsp1.dsp1 <- ergm(EVNETN~edges + degree(4:11) + degree(20) + esp(5:13) + esp(19) + nsp(1) + dsp(1), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.4_6d.8_12d.20d.esp5_1319.pol.pnp <- ergm(EVNETN~edges + degree(4:6) + degree(8:12) + degree(20) + esp(5:13) + esp(19) + nodematch("political") + nodematch("polnotpol"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.4_6d.8_12d.20d.esp5_1319.pol.pnp.core5 <- ergm(EVNETN~edges + degree(4:6) + degree(8:12) + degree(20) + esp(5:13) + esp(19) + nodematch("political") + nodematch("polnotpol") + nodematch("appropriations") + nodematch("help") + nodematch("agriculture") + nodematch("energycomm") + nodematch("educ_wf"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.4_6d.8_12d.20d.esp5_1319.aff <- ergm(EVNETN~edges + degree(4:6) + degree(8:12) + degree(20) + esp(5:13) + esp(19) + nodematch("affil"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.4_6d.8_12d.20d.esp5_1319.aff.core5 <- ergm(EVNETN~edges + degree(4:6) + degree(8:12) + degree(20) + esp(5:13) + esp(19) + nodematch("affil") + nodematch("appropriations") + nodematch("help") + nodematch("agriculture") + nodematch("energycomm") + nodematch("educ_wf"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.gwesp <- ergm(EVNETN~edges + gwesp(), control=control.ergm(parallel=32, MCMLE.maxit = 50, parallel.type="PSOCK"))
summary(ev.gwesp) 

# Examining open closure and brokerage alongside current best model 

ev.4_11d.gwesp.kpath <- ergm(EVNETN~edges + degree(4:11) + gwesp() + kpath(), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.4_11d.gwesp.kpath) 

ev.4_11d.bkbranch6 <- ergm(EVNETN~edges + degree(4:11) + grorbitFactor("branch", 6, 0), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.4_11d.bkbranch6)
evgof.4_11d.bkbranch6<-gof(ev.4_11d.bkbranch6)
plot(evgof.4_11d.bkbranch6); evgof.4_11d.bkbranch6

ev.4_11d.bkbranch9_11 <- ergm(EVNETN~edges + degree(4:11) + grorbitFactor("branch", 9:11, 0), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.4_11d.bkparty6 <- ergm(EVNETN~edges + degree(4:11) + grorbitFactor("political", 6), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.4_11d.bkparty6)
evgof.4_11d.bkparty6<-gof(ev.4_11d.bkparty6)
plot(evgof.4_11d.bkparty6); evgof.4_11d.bkparty6

ev.4_11d.bkparty_pol_9_11 <- ergm(EVNETN~edges + degree(4:11) + grorbitFactor("political", 9:11, 0), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.4_11d <- ergm(EVNETN~edges + degree(4:11), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.4_11d)
...
ev.4_11d.covten.aff.pol.core5 <- ergm(EVNETN~edges + degree(4:11) + nodecov("tenure") + nodematch("affil") + nodematch("political") + nodematch("appropriations") + nodematch("help") + nodematch("agriculture") + nodematch("energycomm") + nodematch("educ_wf"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.4_11d.aff.core5 <- ergm(EVNETN~edges + degree(4:11) + nodematch("affil") + nodematch("appropriations") + nodematch("help") + nodematch("agriculture") + nodematch("energycomm") + nodematch("educ_wf"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.4_11d.aff.core5)
evgof.4_11d.aff.core5<-gof(ev.4_11d.aff.core5)
plot(evgof.4_11d.aff.core5); evgof.4_11d.aff.core5

ev.4_11d.pol.pnp.core5 <- ergm(EVNETN~edges + degree(4:11) + nodematch("political") + nodematch("polnotpol") + nodematch("appropriations") + nodematch("help") + nodematch("agriculture") + nodematch("energycomm") + nodematch("educ_wf"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.pol.pnp.core5 <- ergm(EVNETN~edges +  nodematch("political") + nodematch("polnotpol") + nodematch("appropriations") + nodematch("help") + nodematch("agriculture") + nodematch("energycomm") + nodematch("educ_wf"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.pol.pnp.core5)
evgof.pol.pnp.core5<-gof(ev.pol.pnp.core5)
plot(evgof.pol.pnp.core5); evgof.pol.pnp.core5

ev.4_11d.pol.pnp <- ergm(EVNETN~edges + degree(4:11) + nodematch("political") + nodematch("polnotpol"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.4_11d.pol.pnp)
evgof.4_11d.pol.pnp<-gof(ev.4_11d.pol.pnp)
plot(evgof.4_11d.pol.pnp); evgof.4_11d.pol.pnp

ev.4_11d.polfac.pnp <- ergm(EVNETN~edges + degree(4:11) + nodefactor("political") + nodematch("polnotpol"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.4_11d.polfac.pnp.core5 <- ergm(EVNETN~edges + degree(4:11) + nodefactor("political") + nodematch("polnotpol") + nodematch("appropriations") + nodematch("help") + nodematch("agriculture") + nodematch("energycomm") + nodematch("educ_wf"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
...
ev.polfac.branchfac.core5 <- ergm(EVNETN~edges + nodefactor("political") + nodefactor("branch") + nodematch("appropriations") + nodematch("help") + nodematch("agriculture") + nodematch("energycomm") + nodematch("educ_wf"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.polfac.branchfac.core5)
evgof.polfac.branchfac.core5<-gof(ev.polfac.branchfac.core5)
plot(evgof.polfac.branchfac.core5); evgof.polfac.branchfac.core5

ev.4_11d.polfac.branchfac <- ergm(EVNETN~edges + degree(4:11) + nodefactor("political") + nodefactor("branch"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.4_11d.polfac.branchfac)
evgof.4_11d.polfac.branchfac<-gof(ev.4_11d.polfac.branchfac)
plot(ev.4_11d.polfac.branchfac); ev.4_11d.polfac.branchfac

ev.4_11d.polfac.branchfac.core5 <- ergm(EVNETN~edges + degree(4:11) + nodefactor("political") + nodefactor("branch") + nodematch("appropriations") + nodematch("help") + nodematch("agriculture") + nodematch("energycomm") + nodematch("educ_wf"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
summary(ev.4_11d.polfac.branchfac.core5)
...
ev.4_11d.polfac.affilfac.core5 <- ergm(EVNETN~edges + degree(4:11) + nodefactor("political") + nodefactor("affil") + nodematch("appropriations") + nodematch("help") + nodematch("agriculture") + nodematch("energycomm") + nodematch("educ_wf"), control=control.ergm(parallel=32, MCMLE.maxit = 25, parallel.type="PSOCK"))
